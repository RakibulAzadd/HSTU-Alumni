						...
						<table class="table table-condensed table-bordered table-hover">
							...
							<thead>
								<tr>
									...
									<th class="">Name</th>
									<th class="">SID</th>
									<th class="">Graduated of Department</th>
									<th class="">Status</th>
							...
							<tbody>
								<?php 
								$i = 1;
								$alumni = $conn->query("SELECT a.*,c.course,Concat(  a.firstname,' ',a.middlename ) as name from alumnus_bio a inner join courses c on c.id = a.course_id order by Concat(  a.firstname,' ',a.middlename ,' ', a.lastname) asc");
