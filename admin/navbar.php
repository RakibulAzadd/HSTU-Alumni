...
<nav id="sidebar" class='mx-lt-5 bg-dark' >
		...
		<div class="sidebar-list">
				...
				<a href="index.php?page=courses" class="nav-item nav-courses"><span class='icon-field'><i class="fa fa-list"></i></span> Department</a>
				...
				<a href="index.php?page=forums" class="nav-item nav-forums"><span class='icon-field'><i class="fa fa-donate"></i></span> Donation</a>
				<a href="index.php?page=committee" class="nav-item nav-committee"><span class='icon-field'><i class="fa fa-user"></i></span> Committee</a>
