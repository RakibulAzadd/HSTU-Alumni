...
<?php
if(isset($_GET['id'])){
$qry = $conn->query("SELECT a.*,c.course,Concat( a.firstname,' ',a.middlename  ) as name from alumnus_bio a inner join courses c on c.id = a.course_id where a.id= ".$_GET['id']);
	...
	<div class="col-lg-12">
		...
		<div class="row">
			<div class="col-md-6">
				...
				<p>Student ID: <b><?php echo $lastname ?></b></p>
				<p>Email: <b><?php echo $email ?></b></p>
				<p>Batch: <b><?php echo $batch ?></b></p>
				<p>Department : <b><?php echo $course ?></b></p>
			</div>
			<div class="col-md-6">
