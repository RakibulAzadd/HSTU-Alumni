	...
	margin:unset;
        ...
        <header class="masthead">
            ...
            <div class="container-fluid mt-3 pt-2">
                ...
                $alumni = $conn->query("SELECT a.*,c.course,Concat(a.firstname,' ',a.middlename ) as name from alumnus_bio a inner join courses c on c.id = a.course_id order by Concat(a.lastname,', ',a.firstname,' ',a.middlename) asc");
