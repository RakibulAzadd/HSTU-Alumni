    ...
    <div class="container-fluid h-100">
        <div class="row h-100 align-items-center justify-content-center text-center">
            ...
            <div class="row col-md-12 mb-2 justify-content-center">
                    <button class="btn btn-primary btn-block col-sm-4" type="button" id="new_forum"><i class="fa fa-plus"></i> Create a post for Donation</button>
            </div>   
            </div>
            ...
            <div class="row  align-items-center justify-content-center text-center h-100">
                <div class="">
                    ...
                    <span class="badge badge-info float-left px-3 pt-1 pb-1">
                        <b><i>Written by: <span class="filter-txt"><?php echo $row['name'] ?></span></i></b>
                    </span>
                    ...
                    <button class="btn btn-primary float-right view_topic" data-id="<?php echo $row['id'] ?>">View Post</button>
                </div>
            </div>
...
<script>
    ...
    $('#new_forum').click(function(){
        uni_modal("Create a Post for Donation ","manage_forum.php",'mid-large')
    })
