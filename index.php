...
a.jqte_tool_label.unselectable {
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
            ...
            <a class="navbar-brand js-scroll-trigger text-white" href="./"><img   src="./assets/img/hstu_logo.png" alt="" width="60" height="50">  HSTU Alumni Association</a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto my-2 my-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="index.php?page=forum">Donation</a></li>
                        <?php endif; ?>
...
<div class="modal fade" id="confirm_modal" role='dialog'>
  ...
  <div id="preloader"></div>
       ...
       <?php    include('./footerchoto/footer.php');
       ?>
         
            <!-- <div class="container">
              <p  class="mt-0 text-white" >HOME44e</p>             
                ...
                <div class="row">
                    <div class="col-lg-4 ml-auto text-center mb-5 mb-lg-0">
                        ...
                        <div class="text-white">01611580264</div>
                    </div>
                    <div class="col-lg-4 mr-auto text-center">
                        <i class="fas fa-envelope fa-3x mb-3 text-muted"></i>
                         Make sure to change the email address in BOTH the anchor text and the link target below!
                         <a class="d-block" href="#">rakib@gmail.com</a>
                    </div>
                </div>
            </div>
            <br>
            <div class="container"><div class="small text-center text-muted">Copyright © 2024  | <a href="https://www.hstu.ac.bd/" target="_blank">HSTU</a></div></div>  -->
        </footer>
