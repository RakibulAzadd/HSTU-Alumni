...
<div class="modal-footer display">
	<div class="row">
		<div class="col-md-12">
		   <button class="btn float-left  btn-primary px-4 py-2" type="button" >Apply</button>
			<button class="btn float-right btn-secondary px-4 py-2" type="button" data-dismiss="modal">Close</button>
		</div>
	</div>
</div>
<style>
